...
<body>
    <div class="container">
        ...
        <div class="header" style="gap: 20px;">
            <div class="stat-card">
                <div class="stat-label">1h Range</div>
                <div class="stat-value" style="font-size: 1.2em;" id="range-1h">-</div>
            </div>
            <div class="stat-card">
                <div class="stat-label">24h Range</div>
                <div class="stat-value" style="font-size: 1.2em;" id="range-24h">-</div>
            </div>
            <div class="stat-card">
    ...
    <script>
        ...
        async function loadData() {
            ...
            document.getElementById('range-1h').textContent = `${hourRange[0].toLocaleString()} - ${hourRange[1].toLocaleString()}`;
